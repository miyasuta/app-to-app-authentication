 ...
 * @property {Integer} timeout request timeout in ms 
 ...
 * @property {String} tenant tenant on the same subaccount for which to fetch a token
 ...
 * @property {Integer} expires_in number of seconds until the access token expires
