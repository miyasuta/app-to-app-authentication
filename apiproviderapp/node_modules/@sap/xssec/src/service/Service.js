...
const ExpiredTokenError = require("../error/validation/ExpiredTokenError");
const WrongAudienceError = require("../error/validation/WrongAudienceError");
...
const { NotYetValidTokenError, MissingKidError } = require("../error");
...
class Service {
    ...
    constructor(credentials, serviceConfiguration = {}) {
        ...
        this.jwksCache = new ResponseCache({ ...this.config.validation.jwks, endpointName: "JWKS" });
    }
    ...
    */
    ...
    async createSecurityContext(token, contextConfig = {}) {
        throw new XssecError("This abstract function MUST be provided by a service-specific implementation.");
    }
     ...
     * @returns {Promise<String>} URL of the service's token endpoint
     */
